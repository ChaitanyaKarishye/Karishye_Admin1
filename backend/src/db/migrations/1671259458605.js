module.exports = {
    ...
    async up(queryInterface, Sequelize) {
        ...
        try {
                    ...
                    await queryInterface.createTable('puja_models', {
                        id: {
                    ...
                    await queryInterface.createTable('puja_model_samagri_mappings', {
                        id: {
                            type: Sequelize.DataTypes.UUID,
                            defaultValue: Sequelize.DataTypes.UUIDV4,
                            primaryKey: true,
    ...
    async down(queryInterface, Sequelize) {
        ...
        try {
                    ...
                    await queryInterface.dropTable('puja_model_samagri_mappings', { transaction });
