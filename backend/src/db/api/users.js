...
,
    ...
    first_time_login: data.data.first_time_login
    ||
    null
,

    forgot_password_token: data.data.forgot_password_token
    ||
    null
,
...
,
    ...
    forgot_password_token_timestamp: data.data.forgot_password_token_timestamp
    ||
    null
,
...
,
        ...
        forgot_password_token_timestamp: data.forgot_password_token_timestamp
        ||
        null
,
