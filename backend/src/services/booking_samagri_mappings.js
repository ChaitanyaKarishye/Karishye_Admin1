...
module.exports = class Booking_samagri_mappingsService {
  static async create(data, currentUser) {
    ...
    try {
      await Booking_samagri_mappingsDBApi.create(data, {
        currentUser,
        transaction,
      });
  ...
  static async update(data, id, currentUser) {
    ...
    try {
      ...
      if (!booking_samagri_mappings) {
        throw new ValidationError('booking_samagri_mappingsNotFound');
      }

      await Booking_samagri_mappingsDBApi.update(id, data, {
        currentUser,
        transaction,
      });
  ...
  static async remove(id, currentUser) {
    ...
    try {
      ...
      await Booking_samagri_mappingsDBApi.remove(id, {
        currentUser,
        transaction,
      });
