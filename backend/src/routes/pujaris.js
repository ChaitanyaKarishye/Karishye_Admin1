...
router.post('/', async (req, res) => {
    await PujarisService.create(req.body.data, req.currentUser, true, req.headers.referer);
    const payload = true;
...
router.get('/', wrapAsync(async (req, res) => {
  const payload = await PujarisDBApi.findAll(
    req.query,
  );
...
router.get('/:id', wrapAsync(async (req, res) => {
  const payload = await PujarisDBApi.findBy(
    { id: req.params.id },
  );
