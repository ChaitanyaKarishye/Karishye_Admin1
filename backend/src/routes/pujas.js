...
router.post('/', async (req, res) => {
    await PujasService.create(req.body.data, req.currentUser, true, req.headers.referer);
    const payload = true;
...
router.get('/', wrapAsync(async (req, res) => {
  const payload = await PujasDBApi.findAll(
    req.query,
  );
...
router.get('/:id', wrapAsync(async (req, res) => {
  const payload = await PujasDBApi.findBy(
    { id: req.params.id },
  );
