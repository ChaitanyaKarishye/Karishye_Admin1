    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Switch>
          ...
          <Route
            path={'/admin/puja_models'}
            exact
            component={Puja_modelsTablePage}
          />
          <Route
            path={'/admin/puja_models/new'}
            exact
            component={Puja_modelsFormPage}
          />
          <Route
            path={'/admin/puja_models/:id/edit'}
            exact
            component={Puja_modelsFormPage}
          />

          <Route
            path={'/admin/puja_model_samagri_mappings'}
            exact
            component={Puja_model_samagri_mappingsTablePage}
          />
          <Route
            path={'/admin/puja_model_samagri_mappings/new'}
            exact
            component={Puja_model_samagri_mappingsFormPage}
          />
          <Route
            path={'/admin/puja_model_samagri_mappings/:id/edit'}
            exact
            component={Puja_model_samagri_mappingsFormPage}
          />
        </Switch>
