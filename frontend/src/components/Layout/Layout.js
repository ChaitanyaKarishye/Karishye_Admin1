        ...
        <div className={classes.root}>
            ...
            >
                ...
                <Switch>
                    ...
                    <Route path={"/admin/karusers/new"} exact component={KarusersFormPage} />
                    <Route path={"/admin/karusers/:id/edit"} exact component={KarusersFormPage} />

                    <Route path={"/admin/booking_participants"} exact component={Booking_participantsTablePage} />
                    <Route path={"/admin/booking_participants/new"} exact component={Booking_participantsFormPage} />
                    <Route path={"/admin/booking_participants/:id/edit"} exact component={Booking_participantsFormPage} />

                    <Route path={"/admin/pujaris"} exact component={PujarisTablePage} />
                    <Route path={"/admin/pujaris/new"} exact component={PujarisFormPage} />
                    <Route path={"/admin/pujaris/:id/edit"} exact component={PujarisFormPage} />

                    <Route path={"/admin/pujari_applications"} exact component={Pujari_applicationsTablePage} />
                    <Route path={"/admin/pujari_applications/new"} exact component={Pujari_applicationsFormPage} />
                    <Route path={"/admin/pujari_applications/:id/edit"} exact component={Pujari_applicationsFormPage} />
                    ...
                    <Route path={"/admin/booking_samagri_mappings"} exact component={Booking_samagri_mappingsTablePage} />
                    <Route path={"/admin/booking_samagri_mappings/new"} exact component={Booking_samagri_mappingsFormPage} />
                    <Route path={"/admin/booking_samagri_mappings/:id/edit"} exact component={Booking_samagri_mappingsFormPage} />
