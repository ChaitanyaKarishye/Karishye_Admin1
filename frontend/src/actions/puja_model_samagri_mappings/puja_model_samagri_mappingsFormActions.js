...
const actions = {
  doNew: () => {
    return {
      type: 'PUJA_MODEL_SAMAGRI_MAPPINGS_FORM_RESET',
    };
  },
  ...
  doFind: (id) => async (dispatch) => {
    try {
      ...
      dispatch({
        type: 'PUJA_MODEL_SAMAGRI_MAPPINGS_FORM_FIND_ERROR',
      });
  ...
  doCreate: (values) => async (dispatch) => {
    try {
      ...
      dispatch({
        type: 'PUJA_MODEL_SAMAGRI_MAPPINGS_FORM_CREATE_ERROR',
      });
    }
  },
  ...
  doUpdate: (id, values, isProfile) => async (
    ...
    try {
      ...
      dispatch({
        type: 'PUJA_MODEL_SAMAGRI_MAPPINGS_FORM_UPDATE_SUCCESS',
      });
      ...
      dispatch({
        type: 'PUJA_MODEL_SAMAGRI_MAPPINGS_FORM_UPDATE_ERROR',
      });
    }
  },
};
