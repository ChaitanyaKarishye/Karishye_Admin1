...
const SamagriTable = () => {
  ...
  const [filters, setFilters] = React.useState([
    {label: 'Name', title: 'name'},{label: 'Description', title: 'description'},
          {label: 'Standard Qty', title: 'standard_qty', number: 'true'},{label: 'Price Standard Qty', title: 'price_standard_qty', number: 'true'},{label: 'Units In Stock', title: 'units_in_stock', number: 'true'},
  ...
  const columns = [
      ...
      { field: "price_standard_qty",

        flex: 0.6,

      headerName: "Price Standard Qty"
      },
