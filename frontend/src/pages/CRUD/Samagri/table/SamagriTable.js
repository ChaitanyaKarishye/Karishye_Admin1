...
const SamagriTable = () => {
  ...
  const [filters, setFilters] = React.useState([
    ...
    { label: 'Standard Qty', title: 'standard_qty', number: 'true' },
    {
      label: 'Price Standard Qty',
      title: 'price_standard_qty',
      number: 'true',
    },
    { label: 'Units In Stock', title: 'units_in_stock', number: 'true' },
  ]);
      ...
      <Widget title={<h4>{humanize('Samagri')}</h4>} disableWidgetMenu>
        ...
        >
          <DataGrid
            ...
            loading={loading}
            onRowClick={(e) => {
              history.push(`/admin/samagri/${e.id}/edit`);
            }}
            autoHeight
          />
        </div>
