...
const BookingsTable = () => {
  ...
  const [filters, setFilters] = React.useState([
    ...
    { label: 'Pujari Id', title: 'pujari_id', number: 'true' },
    { label: 'Puja Id', title: 'puja_id', number: 'true' },
    { label: 'Price', title: 'price', number: 'true' },
    { label: 'Duration Hrs', title: 'duration_hrs', number: 'true' },
    { label: 'Base Price', title: 'base_price', number: 'true' },
    { label: 'Final Price', title: 'final_price', number: 'true' },
  ]);
      ...
      <Widget title={<h4>{humanize('Bookings')}</h4>} disableWidgetMenu>
        ...
        >
          <DataGrid
            ...
            loading={loading}
            onRowClick={(e) => {
              history.push(`/admin/bookings/${e.id}/edit`);
            }}
            autoHeight
          />
        </div>
